...
export const App = () => {
  ...
  return (
    <div className="bg-[#081b29] text-white relative">
      {/* Side Navigation */}
      <div className={`side-nav min-h-screen md:hidden text-white bg-[#ccc] ${display} animate-slideIn fixed top-0 left-0 w-full z-50`}>
          ...
          {["home", "about", "projects", "contact"].map((section) => (
            <li
              ...
              className={`rounded-lg px-[10px] py-[5px] hover:text-[aqua] ${
                activeSection === section ? "border-y-[2px] border-b-[white] " : ""
     ...
     <section id="home" className='Home  w-full md:p-[20px] flex flex-col gap-[20px] rounded-md shadow-2xl'>
           <div className="details-wrap flex flex-col-reverse md:flex-row md:h-[540px] justify-between px-[30px] items-center shadow-lg p-[10px]">
                      <div className="content-wrap flex flex-col justify-center md:w-1/2">
                          <h1 className='text-white text text-[24px] md:text-[50px] leading-none mb-[10px] md:mb-[30px] md:px-[30px] font-bold animate-right'>Hi,I'm</h1>
                          <h1 className='text-white text text-[24px] md:text-[40px] leading-none mb-[10px] md:mb-[30px] md:px-[30px] animation animate-right'>Dharaneeswar</h1>
                          <p className='text-[white] md:text-2xl mb-[20px] md:px-[30px] animate-left'>A passionate <span className="text-[aqua] font-semibold">Frontend Developer </span> creating seamless and stunning user experiences.</p>
                          <button className='rounded-lg md:mx-[30px] h-[40px] w-[200px] hover:bg-[aqua] text-[aqua] border-[aqua] border-[2px] font-semibold mt-[20px] px-[10px] animate-top'>
          Download Resume
        </button>
                      </div>
...
<div className="relative lg:w-[400px] lg:h-[400px] flex justify-center items-center overflow-visible border-[3px] rounded-full p-[10px]" >
  ...
  <div className="image-wrapper h-full w-full z-20">
    ...
    />
      ...
      <h1 className=" font-semibold text-[40px] text-white pt-[100px] text-center" id="about">About <span className="text-[aqua]">Me</span></h1>
        ...
        <div className="detais-wrap flex flex-col md:gap-[10px]  rounded-lg shadow-lg p-[10px] md:p-[20px]">
          ...
          <div className="education shadow-lg p-[10px] rounded-lg w-full md:w-1/2">
            ...
            <ul className="flex flex-col gap-[20px] w-full relative after:absolute after:h-full after:w-[3px] after:top-0 after:bg-[aqua]  rounded-lg p-[10px] after:left-[-10px] md:after:left-[-20px]">
              <li className="border-[1px] border-[aqua] p-[10px] rounded-lg relative after:absolute after:h-[20px] after:w-[20px] after:bg-[aqua] after:rounded-full after:left-[-30px] md:after:left-[-40px]">SSC: St. Antony's E.M High School, Kadapa</li>
              <li className="border-[1px] border-[aqua] p-[10px] rounded-lg relative after:absolute after:h-[20px] after:w-[20px] after:bg-[aqua] after:rounded-full after:left-[-30px] md:after:left-[-40px]">Intermediate: RGUKT Nuzvid</li>              <li className="border-[1px] border-[aqua] p-[10px] rounded-lg relative after:absolute after:h-[20px] after:w-[20px] after:bg-[aqua] after:rounded-full after:left-[-30px] md:after:left-[-40px]">BTech: RGUKT Nuzvid</li>
              <li className="border-[1px] border-[aqua] p-[10px] rounded-lg relative after:absolute after:h-[20px] after:w-[20px] after:bg-[aqua] after:rounded-full after:left-[-30px] md:after:left-[-40px]">Currently Studying: BTech 2nd year, CSE</li>
            </ul>
          </div>
 ...
 <h1 className="text-[40px] text-[aqua] font-semibold pt-[100px]  text-center" id="projects">Projects</h1>
      <section className="Projects w-full  p-[10px] md:p-[20px] flex flex-col gap-[30px] items-center shadow-xxl">
        <div className="cards-wrap flex flex-wrap justify-center gap-[10px] md:gap-[20px]  md:py-[50px]  rounded-lg relative  shadow-xxl">
              <a href="https://gigo-gamma.vercel.app/" className="shadow-lg border-[2px] border-[aqua] rounded-lg overflow-hidden"><Card image={gigo}/></a>
             
              <a href="https://database-dashboard-adr.vercel.app/" className="shadow-lg border-[2px] border-[aqua] rounded-lg overflow-hidden"><Card image={dashboard}/></a>
              
              <a href="https://dharaneeswarreddyavula.netlify.app/" className="shadow-lg border-[2px] border-[aqua] rounded-lg overflow-hidden"><Card image={stocker}/></a>
              
              <a href="https://martex-clone.vercel.app/" className="shadow-lg border-[2px] border-[aqua] rounded-lg overflow-hidden"><Card image={matrex}/></a>
             
        </div>
      </section>
      <h1 className="text-[30px] text-white pt-[100px] text-center font-semibold" id="contact">Contact <span className="text-[aqua]">Me</span></h1>
  ...
  />
      ...
      <footer className="bg-gray-800 text-white py-4">
        ...
        <div className="contact-info mb-6 shadow-lg p-[20px] w-full">
              <p>
                <strong className="text-[20px]">Email:</strong> avladharaniswarreddy@gmail.com
              </p>
              <p>
                <strong className="text-[20px]">Phone:</strong> 8790756930
              </p>
              <p>
                <strong className="text-[20px]">Address:</strong> E.Ramapuram, Kalasapadu,
                <br />
                Kadapa, AP
              </p>
            </div>
